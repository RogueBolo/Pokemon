...
p1 = input("What pokemon would you like to use?(infernape or mewto)\n")
p

z1 = input("What attack to use?(tackle, flamethrower, hyperbeam or ice punch)\n")

z2 = input("What attack to use?(tackle, flamethrower, hyperbeam or ice punch)\n")


accuracy = 0


if z1 == "tackle" or z2 == "tackle":
        accuracy = tackle.get_accuracy()
       

elif z1 == "flamethrower" or z2 == "flamethrower":
        accuracy = flamethrower.get_accuracy()

elif z1 == "hyperbeam" or z2 == "hyperbeam":
        accuracy = hyperbeam.get_accuracy()

elif z1 == "ice punch" or z2 == "Ice punch":
...
if y == True:
      ...
      ##### 2 Player Attack Mechanics
        p1.attack1(p2)
                        print(p1+" attacked with "+ z1)